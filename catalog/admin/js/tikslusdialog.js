...
$("body").append('<div id="tdialog"><div class="wrapper_up"><div class="title"></div><div id="icon"></div><div class="controls"></div></div><div id="content_wrapper"><div class="content"></div><div class="buttons_tik"></div></div></div>');



$("#tdialog").find(".title").html("");
$("#tdialog").find(".content").html("");
$("#tdialog").find(".buttons_tik").html("");
if(options.icon=="")
{
...
btns=CreateButtons();//create buttons
  ...
  btns="<ul><li><a href='#' class='button_ok'>Ok</a></li></ul>";
   ...
   $("#tdialog").find(".buttons_tik").html("").append(btns);//append Ok button to the dialog
  ...
  btns="<ul><li><a href='#' class='button_ok'>Ok</a></li></ul>";
   ...
   $("#tdialog").find(".buttons_tik").html("").append(btns);
  ...
  btns="<ul><li><a href='#' class='button_ok'>Ok</a></li><li><a href='#' class='button_cancel'>Cancel</a></li></ul>";
   ...
   if(options.content)
   {
   con= $("#tdialog").find(".content").html()+ "<input class='form-control' type='text' id='newValue' value=''>";
   }
   else
   {
   con= "<input class='form-control' type='text' id='newValue' value=''>";
   }
...
$('#tdialog').css("display","block").animate({top:-($("#tdialog").height()+10)},options.animationSpeed).fadeOut("fast");
}

if((options.position).indexOf("bottom")>=0)
{
$('#tdialog').css("display","block").animate({top:$(window).height()+$("#tdialog").width()},options.animationSpeed).fadeOut("fast");
...
{
$('#tdialog').css("display","block").animate({left:screen.width+($("#tdialog").width()+10)},options.animationSpeed).fadeOut("fast");
}
else if(options.effect=="slide right")
{
$('#tdialog').css("display","block").animate({left:-($("#tdialog").width()+10)},options.animationSpeed).fadeOut("fast");
}
else if(options.effect=="css3"){
$("#tdialog").removeClass(options.css3Effectin).addClass("animated").addClass(options.css3EffectOut).fadeOut("fast");
}
else
{
$("#tdialog").fadeOut("fast");
