  ...
  <div class="contentText" style="margin-top: 15px;">
    <div class="row hidden-xs">
      <div class="col-lg-4 text-center">
        <?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '" class="checkoutBarCurrent">' . CHECKOUT_BAR_DELIVERY . '</a>'; ?>
      </div>
      <div class="col-lg-4 text-center">
    ...
    <div style="float: right;"><?php echo tep_draw_button('<span class="glyphicon glyphicon-ok"></span> '.IMAGE_BUTTON_CONTINUE, '', null,'primary',null, 'btn btn-default btn-lg');?></div>
  </div>
</div>
