...
?>
  ...
  <div class="contentText" style="margin-top: 15px;">
    <div class="row hidden-xs">
      <div class="col-lg-4 text-center">
        <?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '">' . CHECKOUT_BAR_DELIVERY . '</a>'; ?>
      </div>
      <div class="col-lg-4 text-center">
        <?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '">' . CHECKOUT_BAR_PAYMENT . '</a>'; ?>
      </div>
      <div class="col-lg-4 text-center">
...
<?php
  ...
  echo tep_draw_button('<span class="glyphicon glyphicon-ok"></span> '.IMAGE_BUTTON_CONFIRM_ORDER, 'check', null, 'primary',null, 'btn btn-default btn-lg');
?>
